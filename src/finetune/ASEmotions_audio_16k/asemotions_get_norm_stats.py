# -*- coding: utf-8 -*-
# @Time    : 28/11/23 15:11 PM
# @Author  : Hyosun Choi
# @Affiliation  : RHUL
# @Email   : 
# @File    : asemotions_get_norm_stats.py
...
audio_conf = {'num_mel_bins': 128, 'target_length': 1024, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'asemotions'} #[Hyosun: the original code]
# audio_conf = {'num_mel_bins': 128, 'target_length': 400, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'asemotions'}
...
train_loader = torch.utils.data.DataLoader(
    ...
    dataloader.AudioDataset('./data/datafiles/asemotions_train_data_1.json', label_csv='./data/asemotions_class_labels_indices.csv',
