...
labels_info_arr = ['01_Boredom_Sigh', '02_Neutral_Calm', '03_Happy_Laugh_Gaggle', '04_Sad_Cry', '05_Angry_Grunt_Frustration', 
                  '06_Fearful_Scream_Panic_11_Pain_Groan']#, #'07_Disgust_Dislike_Contempt',
                  #'08_Surprised_Gasp_Amazed',#'09_Excited', #'10_Pleasure',
                  #'11_Pain_Groan',#'12_Disappointment_Disapproval',#'13_Breath'
                  #] # mix-up: 06&11
labels_arr = ['01', '02', '03', '04', '05', '06'] #, '07', '08', '09', '10', '11', '12'] #, '13']
actor_arr = []
...
os.path.exists('./data/evaluation_setup/fold1_test.csv') == False:
    ...
    base_dir = './data/ASEmotions_audio_16k_intolabels_4s/'
    import random
    train_dict_list = []
    test_dict_list = []
    labels = []
...
if os.path.exists('./data/asemotions_class_labels_indices.csv') == False:
    ...
    for i in range(0,len(labels_arr)): #12 labels for ASEmotions
        index.append(i) #[Hyosun] for ASEmotions as the label ranges from 1 to 12
...
base_path = os.path.abspath(os.getcwd()) + "/data/ASEmotions_audio_16k_intolables_4s/"
