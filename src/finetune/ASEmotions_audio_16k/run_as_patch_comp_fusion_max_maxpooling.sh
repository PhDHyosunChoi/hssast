...
# prep birdsong dataset and download the pretrained model
if [ -e data/datafiles ]
then
...
timem=96
mixup=0
epoch=2 #22 #45 #50 #10 #50 #50 #5  #50 [Hyosun] The original epoch 50: reduced into 5 for experiments
batch_size=48
fshape=16
tshape=16
fstride=10
...
do
  ...
  tr_data=./data/datafiles/asemotions_train_data_${fold}.json
  te_data=./data/datafiles/asemotions_test_data_${fold}.json

  CUDA_CACHE_DISABLE=1 python -W ignore ../../run.py --dataset ${dataset} \
  --data-train ${tr_data} --data-val ${te_data} --exp-dir $exp_dir \
  --label-csv ./data/asemotions_class_labels_indices.csv --n_class 6 \
...
python get_asemotions_result.py --exp_path ${base_exp_dir} #요거이용하기(2023-10-02)
#[/Hyosun] edited 2023-10-17