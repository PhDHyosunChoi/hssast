# -*- coding: utf-8 -*-
# @Time    : 01/12/23 11:06 AM
# @Author  : Hyosun Choi
# @Affiliation  : RHUL
# @Email   : 
# @File    : birdsong_get_norm_stats.py
...
audio_conf = {'num_mel_bins': 128, 'target_length': 1024, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'birdsong'}
...
train_loader = torch.utils.data.DataLoader(
    ...
    dataloader.AudioDataset('./data/datafiles/birdsong_train_data_1.json', label_csv='./data/birdsong_class_labels_indices.csv',
