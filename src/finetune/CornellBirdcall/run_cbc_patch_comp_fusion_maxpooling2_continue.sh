...
# prep cbc dataset and download the pretrained model
if [ -e data/datafiles ]
then
    echo "cbc already downloaded and processed."
else
    python prep_cbc.py
fi
...
#05:51:03AM-continuing_train-cbc-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp2-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--checkpoint-1x-noiseTrue
pretrain_path='/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2024-05-12/07:50:49AM-continuing_train-cbc-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp2-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--checkpoint-1x-noiseTrue/fold1/models/best_audio_model.pth'
#'/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2024-05-11/15:45:08PM-continuing_train-cbc-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp2-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--checkpoint-1x-noiseTrue/fold1/models/best_audio_model.pth'
#'/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2024-05-10/14:43:19PM-continuing_train-cbc-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp2-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--checkpoint-1x-noiseTrue/fold1/models/best_audio_model.pth'
#'/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2024-05-09/13:21:02PM-test01-cbc-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp2-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1/models/best_audio_model.pth'
#'/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2024-04-27/11:26:10AM-test01-cbc-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp6-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1'
continue_train='True' #[Hyosun] added 2024-04-29
  #[Hyosun] optimizer_path added 2024-05-02
#optimizer_state=best_optim_state
#optimizer_path='/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2024-05-04/15:16:07PM-test01-cbc-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp6-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1/models/best_optim_state.pth'
  #[/Hyosun] optimizer_path added 2024-05-02
#[/Hyosun] continue_train added 2024-04-30

#[Hyosun] dataset cbc 
dataset=cbc
dataset_mean=-6.554686
dataset_std=4.7510896
target_length=512
noise=True
#[/Hyosun] dataset cbc
...
timem=96
mixup=0
epoch=100 #60 #45 #50 #10 #50 #50 #5  #50 [Hyosun] The original epoch 50: reduced into 5 for experiments
batch_size=48
fshape=16
tshape=16
fstride=10
...
pooling_ty='max' #[Hyosun] #choices=["mean", "min", "max", "mean_min", "mean_max"] #[/Hyosun]
mlp_layers=2
#[/Hyosun] comp_fusion logic added
...
base_exp_dir=./exp/"$(date +'%Y-%m-%d/%H:%M:%S%p')"-continuing_train-${dataset}-comp_fusion-${comp_fusion}-comp_fusion_method-${comp_fusion_method}-comp_fusion_multi_layer-${comp_fusion_multi_layer}-pooling-${pooling_ty}-comp_fusion_mlp${mlp_layers}-loss-${loss}-f${fstride}-${fshape}-t${tstride}-${tshape}-b${batch_size}-lr${lr}-${task}-${model_size}-${pretrain_exp}-${pretrain_model}-${head_lr}x-noise${noise} 
...
do
  ...
  --label-csv ./data/birdsong_class_labels_indices.csv --n_class 264 \
...
#[Hyosun] added:   --optimizer_path ${optimizer_path} [/Hyosun] 2024-05-02
