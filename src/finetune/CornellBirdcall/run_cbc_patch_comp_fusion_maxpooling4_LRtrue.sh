...
#[Hyosun] cbc setting: edited for cbc mean= std=
dataset=cbc
dataset_mean=-6.554686
dataset_std=4.7510896
target_length=512
noise=True
#[/Hyosun] cbc setting: edited for birdsong mean= std=
...
timem=96
mixup=0
epoch=100 #50 #22 #45 #50 #10 #50 #50 #5  #50 [Hyosun] The original epoch 50: reduced into 5 for experiments
batch_size=48
fshape=16
tshape=16
fstride=10
