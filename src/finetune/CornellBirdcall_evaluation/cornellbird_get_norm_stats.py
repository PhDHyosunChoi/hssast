...
# @File    : cornellbird_get_norm_stats.py
...
audio_conf = {'num_mel_bins': 128, 'target_length': 1024, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'cornellbird'}
...
train_loader = torch.utils.data.DataLoader(
    ...
    dataloader.AudioDataset('./data/datafiles/cornellbird_train_data_1.json', label_csv='./data/cornellbird_class_labels_indices.csv',
