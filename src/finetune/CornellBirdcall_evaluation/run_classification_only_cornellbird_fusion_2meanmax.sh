...
pretrain_path='/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2023-12-03/[success]15:51:35PM-test01-birdsong-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-mean_max-comp_fusion_mlp2-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1/models/best_audio_model.pth'
