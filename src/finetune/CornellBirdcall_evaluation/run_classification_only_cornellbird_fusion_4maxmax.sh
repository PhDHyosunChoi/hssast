...
pretrain_path='/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2023-12-02/[success_epoch22]12:11:19PM-test01-birdsong-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max_max-comp_fusion_mlp4-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1/models/best_audio_model.pth'
