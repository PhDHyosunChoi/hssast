...
pretrain_path='/content/drive/MyDrive/hssast/src/finetune/CornellBirdcall/exp/2023-12-04/[success]19:17:48PM-test01-birdsong-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-mean-comp_fusion_mlp4-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1/models/best_audio_model.pth'
