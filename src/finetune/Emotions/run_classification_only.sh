...
then
    ...
    echo "emotions already downloaded and processed."
else
    python prep_cremad.py
fi
...
do
  ...
  tr_data=./data/datafiles/emotions_train_data_${fold}.json
  te_data=./data/datafiles/emotions_test_data_${fold}.json
