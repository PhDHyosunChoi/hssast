...
timem=96
mixup=0
epoch=2 #50 #10 #50 #50 #5  #50 [Hyosun] The original epoch 50: reduced into 5 for experiments
batch_size=48
fshape=16
tshape=16
fstride=10
...
python get_emotions_result.py --exp_path ${base_exp_dir} #요거이용하기(2023-10-02)
#[/Hyosun] edited 2023-10-17