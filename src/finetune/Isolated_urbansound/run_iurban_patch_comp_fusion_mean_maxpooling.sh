...
#[Hyosun] iurbanosund setting: edited for birdsong mean=-0.48460108 std=1.8269863
...
target_length=512
noise=True
#[/Hyosun] iurbansound setting: edited for birdsong mean=-0.48460108 std=1.8269863
