...
#[Hyosun] iurbansound setting: edited for iurbansound mean=-0.48460108 std=1.8269863
...
do
  ...
  --label-csv ./data/iurban_1s_class_labels_indices.csv --n_class 10 \
...
python get_iurban_result.py --exp_path ${base_exp_dir} #[Hyosun added 2023-10-17]
#[/Hyosun]