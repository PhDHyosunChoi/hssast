...
then
    ...
    echo "orievent already downloaded and processed."
else
...
pretrain_path=/content/drive/MyDrive/hssast/src/finetune/Isolated_urbansound_event_evaluation/best_audio_model.pth
# [success]13:32:18PM-test01-iurbanevent-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max_max-comp_fusion_mlp4-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue
classification_only='True'
#[/Hyosun] classification_only added 2024-01-28

#[Hyosun]-6.48797 5.107488
dataset=orievent
dataset_mean=-6.48797
dataset_std=5.107488
target_length=512
noise=True
#[/Hyosun]-6.48797 5.107488
...
do
  ...
  tr_data=./data/datafiles/event_train_data_${fold}.json
  te_data=./data/datafiles/event_test_data_${fold}.json

  CUDA_CACHE_DISABLE=1 python -W ignore ../../run.py --dataset ${dataset} \
  --data-train ${tr_data} --data-val ${te_data} --exp-dir $exp_dir \
  --label-csv ./data/event_class_labels_indices.csv --n_class 11 \
