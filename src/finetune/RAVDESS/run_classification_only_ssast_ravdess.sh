...
#[Hyosun]-3.6328306 6.004225
dataset=ravdess
dataset_mean=-3.6328306
dataset_std=6.004225
target_length=512
noise=True
#[/Hyosun]-3.6328306 6.004225
...
do
  ...
  tr_data=./data/datafiles/ravdess_train_data_${fold}.json
  te_data=./data/datafiles/ravdess_test_data_${fold}.json

  CUDA_CACHE_DISABLE=1 python -W ignore ../../run.py --dataset ${dataset} \
  --data-train ${tr_data} --data-val ${te_data} --exp-dir $exp_dir \
  --label-csv ./data/ravdess_class_labels_indices.csv --n_class 7 \
