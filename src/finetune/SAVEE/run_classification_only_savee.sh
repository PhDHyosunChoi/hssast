...
then
    ...
    echo "savee already downloaded and processed."
else
    python prep_savee.py
fi
...
pretrain_path=/content/drive/MyDrive/hssast/src/finetune/Emotions/exp/2024-01-16/15:03:47PM-test01-emotions-comp_fusion-True-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[4,11]-pooling-max-comp_fusion_mlp6-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1/models/best_audio_model.pth
classification_only='True'
#[/Hyosun] classification_only added 2024-01-28

#[Hyosun]-2.8364258 5.1191854
dataset=savee
dataset_mean=-2.8364258
dataset_std=5.1191854
target_length=512
noise=True
#[/Hyosun]-2.8364258 5.1191854
...
do
  ...
  tr_data=./data/datafiles/savee_train_data_${fold}.json
  te_data=./data/datafiles/savee_test_data_${fold}.json

  CUDA_CACHE_DISABLE=1 python -W ignore ../../run.py --dataset ${dataset} \
  --data-train ${tr_data} --data-val ${te_data} --exp-dir $exp_dir \
  --label-csv ./data/savee_class_labels_indices.csv --n_class 7 \
