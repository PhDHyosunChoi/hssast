# -*- coding: utf-8 -*-
# @Time    : 03/10/23 12:09 PM
# @Author  : Hyosun Choi
# @Affiliation  : RHUL
# @Email   : 
# @File    : tau_get_norm_stats.py
...
import dataloader #[Hyosun comment] 현재파일은 자체제작한 dataloader.py랑 연동되는 파일임

# set skip_norm as True only when you are computing the normalization stats
audio_conf = {'num_mel_bins': 128, 'target_length': 1024, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'tau'}
...
train_loader = torch.utils.data.DataLoader(
    ...
    dataloader.AudioDataset('./data/datafiles/tau_train_data_1.json', label_csv='./data/tau_class_labels_indices.csv',
