...
then
    ...
    echo "tess already downloaded and processed."
else
    python prep_tess.py
fi
...
pretrain_path=/content/drive/MyDrive/hssast/src/finetune/Emotions/exp/2024-01-15/11:55:32AM-test01-emotions-comp_fusion-False-comp_fusion_method-use_all_patch-comp_fusion_multi_layer-[]-pooling-mean-comp_fusion_mlp0-loss-CE-f10-16-t10-16-b48-lr1e-4-ft_avgtok-base--SSAST-Base-Patch-400-1x-noiseTrue/fold1/models/best_audio_model.pth
classification_only='True'
#[/Hyosun] classification_only added 2024-01-28

#[Hyosun]-1.3440604 3.3999963
dataset=tess
dataset_mean=-1.3440604
dataset_std=3.3999963
target_length=512
noise=True
#[/Hyosun]-1.3440604 3.3999963
...
do
  ...
  tr_data=./data/datafiles/tess_train_data_${fold}.json
  te_data=./data/datafiles/tess_test_data_${fold}.json

  CUDA_CACHE_DISABLE=1 python -W ignore ../../run.py --dataset ${dataset} \
  --data-train ${tr_data} --data-val ${te_data} --exp-dir $exp_dir \
  --label-csv ./data/tess_class_labels_indices.csv --n_class 7 \
