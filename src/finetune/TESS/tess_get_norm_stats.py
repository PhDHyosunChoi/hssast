...
audio_conf = {'num_mel_bins': 128, 'target_length': 1024, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'tess'}
...
train_loader = torch.utils.data.DataLoader(
    ...
    dataloader.AudioDataset('./data/datafiles/tess_train_data_1.json', label_csv='./data/tess_class_labels_indices.csv',
