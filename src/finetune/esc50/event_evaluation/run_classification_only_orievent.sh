...
pretrain_path=/content/drive/MyDrive/hssast/src/finetune/event_evaluation/best_audio_model.pth
...
do
  ...
  tr_data=./data/datafiles/orievent_train_data_${fold}.json
  te_data=./data/datafiles/orievent_test_data_${fold}.json

  CUDA_CACHE_DISABLE=1 python -W ignore ../../run.py --dataset ${dataset} \
  --data-train ${tr_data} --data-val ${te_data} --exp-dir $exp_dir \
  --label-csv ./data/orievent_class_labels_indices.csv --n_class 11 \
