...
# edited by Hyosun Choi
# @Time    : 21/03/24 11:37 AM
# @Author  : Hyosun Choi
...
if os.path.exists('./ESC-50-master') == False:
    os.mkdir('./ESC-50-master/') # [Hyosun] added
    esc50_url = 'https://github.com/karoldvl/ESC-50/archive/master.zip'
    wget.download(esc50_url, out='./') #'./data/')#[Hyosun] edited
    ...
    os.mkdir('./ESC-50-master/audio_16k/')
    audio_list = get_immediate_files('./ESC-50-master/audio')
...
for fold in [1,2,3,4,5]:
    base_path = os.path.abspath(os.getcwd()) + "/ESC-50-master/audio_16k/"
    meta = np.loadtxt('./ESC-50-master/meta/esc50.csv', delimiter=',', dtype='str', skiprows=1)
    train_wav_list = []
    eval_wav_list = []
